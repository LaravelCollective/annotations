$router->put('more/{id}', [
	'uses' => 'App\Http\Controllers\Attributes\BasicController@doMore',
	'as' => NULL,
...
{
	$router->resource('foobar/photos', 'App\\Http\\Controllers\\Attributes\\BasicController', ['only' => ['index'], 'names' => ['index' => 'index.name']]);
});
...
{
	$router->resource('foobar/photos', 'App\\Http\\Controllers\\Attributes\\BasicController', ['only' => ['update'], 'names' => []]);
});
